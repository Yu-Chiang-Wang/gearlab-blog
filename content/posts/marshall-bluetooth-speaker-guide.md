...
categories: ["音響"]
slug: "marshall-bluetooth-speaker-guide"
author: "王侑強 / GearLab"
faq:
  - q: "Marshall 藍牙喇叭防水嗎？"
...
Marshall 的藍牙喇叭大概是「一看外型就認得出來」的代表：復古音箱造型、金色 Logo、旋鈕手感。但真的要買的時候，問題就來了——**Willen、Emberton、Middleton、Kilburn、Acton、Stanmore、Woburn……到底差在哪？**

這篇幫你把全系列拆成兩條線、七個主力型號，用官方規格一次比清楚。看完你就能對號入座。

## 先說結論：照你的使用情境對號入座

| 你的情境 | 建議型號 | 一句話理由 |
|---|---|---|
| 隨身帶著走、露營野餐 | **Emberton III** | 0.67 kg + IP67 + 32 小時續航，全系列最平衡 |
...
Marshall 藍牙喇叭其實就兩大類，先選對「線」，再挑型號：

1. **攜帶型（Portable）**——內建電池、防塵防水，帶出門用的。Willen、Emberton、Middleton、Kilburn 都在這條線上。
2. **家用型（Home）**——插電使用、沒有電池，木質音箱的復古造型更完整，聲音規格也更高。就是 Acton、Stanmore、Woburn 三兄弟。

判斷方式很簡單：**這台喇叭會不會離開插座？** 會，選攜帶型；不會，直接看家用型——同價位下，插電的家用款可以把成本全部投在音量和單體上，不用分給電池和防水。

![Marshall Emberton III 攜帶型藍牙喇叭](/images/marshall/emberton-iii-official.jpg)
*攜帶型主力 Emberton III（圖片來源：Marshall 官方網站）*

---

## 攜帶型怎麼選：四個型號的官方規格比較

| | Willen II | Emberton III | Middleton II | Kilburn III |
|---|---|---|---|---|
| **重量** | 0.36 kg | 0.67 kg | 1.8 kg | 2.8 kg |
| **續航（官方標示）** | 17+ 小時 | 32+ 小時 | 30+ 小時 | 50+ 小時 |
| **快充** | 充 20 分鐘用 5.5 小時 | 充 20 分鐘用 6 小時 | 充 20 分鐘用 5 小時 | 充 20 分鐘用 8 小時 |
| **防水防塵** | IP67 | IP67 | IP67 | IP54（防潑水） |
| **360° 聲場（True Stereophonic）** | — | ✅ | ✅ | ✅ |
| **特色** | 背帶固定、免持通話 | 免持通話、多點連線 | **可當行動電源幫手機充電** | Bluetooth 5.3 Auracast、30W USB-C PD 充電 |

（規格來源：Marshall 官網各產品頁）

### Willen II：把「小」做到極致

掌心大小、360 克，附固定背帶可以綁在腳踏車把手或背包上。續航 17+ 小時對這體積來說很夠用，IP67 拿去溪邊也不怕。代價是單體只有一顆 2 吋全音域，物理上不可能有大喇叭的低音——它的定位是「隨身 BGM」，不是派對主角。
...
1.8 kg 就不是「隨身」而是「隨行」了——適合露營、聚會這種開車載過去的場合。兩顆 3 吋低音單體 + 兩顆高音的配置在攜帶型裡最完整，還內建**反向充電**：喇叭本體就是行動電源，手機沒電直接插上去充。

### Kilburn III：半個家用喇叭

2.8 kg、復古提把設計，官方續航 50+ 小時是全系列最長。防水等級降到 IP54（防潑水，不能泡水），定位其實是「主要放家裡、偶爾搬到陽台或朋友家」。兩個對 3C 使用者友善的細節：支援 **Bluetooth 5.3 Auracast**，以及**用 30W USB-C PD 充電**——你幫 MacBook、iPad 準備的 [GaN 充電器](/posts/best-gan-charger-2026/)和 [USB-C 快充線](/posts/usb-c-charging-cable/)可以直接拿來餵它，不用多帶一顆專用變壓器。

![Marshall Kilburn III 攜帶型藍牙喇叭](/images/marshall/kilburn-iii-official.jpg)
*續航 50+ 小時的 Kilburn III，用 USB-C PD 充電（圖片來源：Marshall 官方網站）*

> 👉 [攜帶型全系列與售價：Marshall 官網](https://linkgo.one/s/ChWeD)
...
|---|---|---|---|
| **低音單體功率** | 30W | 50W | 90W |
| **高音** | 2 × 15W | 2 × 15W | 2 × 15W（另有 2 × 15W 中音） |
| **最大音壓** | 95 dB | 97 dB | 100.5 dB |
| **重量** | 2.85 kg | 4.25 kg | 7.45 kg |
| **輸入** | 藍牙、3.5mm | 藍牙、3.5mm、**RCA** | 藍牙、3.5mm、RCA、**HDMI** |
| **適合空間** | 書房、臥室 | 一般客廳 | 大客廳、開放空間 |
...
![Marshall Stanmore III 家用藍牙喇叭](/images/marshall/stanmore-iii-official.jpg)
*家用中階款 Stanmore III，多了 RCA 輸入（圖片來源：Marshall 官方網站）*

> 👉 [家用系列全部型號與售價：Marshall 官網](https://linkgo.one/s/ChWeD)
...
Marshall 在台灣的購買管道大致三種，差別在**保固**和**價格彈性**：
